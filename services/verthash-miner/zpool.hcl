  ...
  dynamic "group" {
    ...
    content {
      ...
      task "srb-miner-task" {
        ...
        config {
          work_dir = "/opt/miners/VerthashMiner"
          command = "/opt/miners/VerthashMiner/VerthashMiner"
          args = [
            "-o", "stratum+tcp://verthash.eu.mine.zpool.ca:6144",
            "-u", "${var.payout.address}",
            "-p", "${group.key},c=${var.payout.coin},zap=VTC",
